...
import { DisplayStoreContent } from "../store";
...
const DataTablesBasic = () => {
    ...
    useEffect(() => {
        dispatch(DisplayStoreContent());
    }, [dispatch, store.Storecontent.length]);
            ...
            {isLoading ? ( // Show the loading spinner while isLoading is true
                ...
                <div className="react-dataTable">
                    <DataTable
                        noHeader
                        pagination
                        data={searchValue.length ? searchData : store.Storecontent}
                        columns={columns}
                        className="react-dataTable"
                        // expandableRows={true}
