...
import { DisplayInputStoreContent } from "../store";
...
const DataTablesBasic = () => {
    ...
    const store = useSelector((state) => state.ultimatestore);
    ...
    useEffect(() => {
        dispatch(DisplayInputStoreContent());
    }, [dispatch, store.InputStorecontent.length]);
    ...
    const hasData = searchValue.length
        ? searchData.length > 0
        : store.InputStorecontent.length > 0;
                        ...
                        <h3 className="text-success">
                            ...
                            {store.InputStorecontent == ""
                                ...
                                : `عدد المدخلات : ${searchValue.length
                                    ? searchData.length
                                    : store.InputStorecontent.length
                                }`}
                        </h3>
                ...
                {/* <div className="d-flex mt-md-0 mt-1">
                    <UncontrolledButtonDropdown>
                        <DropdownToggle
                            ...
                            caret
                            outline
                            disabled={store.InputStorecontent == ""}
                        >
                            <Share size={15} />
            ...
            {isLoading ? ( // Show the loading spinner while isLoading is true
                ...
                <div className="react-dataTable">
                    <DataTable
                        noHeader
                        pagination
                        data={searchValue.length ? searchData : store.InputStorecontent}
                        columns={columns}
                        className="react-dataTable"
                        expandableRows={true}
