...
import { getSlaughterInput } from "../store";
...
const DataTablesBasic = () => {
  ...
  useEffect(() => {
    dispatch(getSlaughterInput());
  }, [dispatch, store.slaughterInput.length]);
      ...
      {isLoading ? ( // Show the loading spinner while isLoading is true
        ...
        <div className="react-dataTable">
          <DataTable
            noHeader
            pagination
            data={searchValue.length ? filteredData : store.slaughterInput}
            columns={columns}
