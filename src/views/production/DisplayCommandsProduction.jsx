...
import { displayCommandsToWarehouse } from "./store";
...
const DataTablesBasic = () => {
    ...
    useEffect(() => {
        dispatch(displayCommandsToWarehouse());
    }, [dispatch, store.Commands.length]);
    ...
    return (
        <Card className="overflow-hidden">
            <CardHeader>
                ...
                {(<a href={`/production/AddCommands`} color="primary">
                <button className='btn-sm btn btn-primary'style={{marginRight:'800px'}} >إضافة امر</button>
                </a>)}
                {/* <div className="d-flex mt-md-0 mt-1">
                    ...
                    <a href={`/production/AddCommands`} color="primary">اضافة امر </a>
            ...
            {isLoading ? ( // Show the loading spinner while isLoading is true
                ...
                <div className="react-dataTable">
                    <DataTable
                        noHeader
                        pagination
                        data={searchValue.length ? searchData : store.Commands}
                        columns={columns}
                        className="react-dataTable"
                        // expandableRows={true}
