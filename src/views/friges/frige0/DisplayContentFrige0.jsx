...
import { DisplayZeroFrigeContent } from "../store";
...
const DataTablesBasic = () => {
    ...
    const hasData = searchValue.length
        ? searchData.length > 0
        : store.ZeroFrigeContent.length > 0;
                ...
                <div className="d-flex mt-md-0 mt-1">
                    <UncontrolledButtonDropdown>
                        <DropdownToggle
                            ...
                            caret
                            outline
                            disabled={store.ZeroFrigeContent == ""}
                        >
                            <Share size={15} />
            ...
            <Row className="justify-content-end mx-0">
                <InputGroup className="mb-2">
                    ...
                    <Input
                        ...
                        placeholder="البحث ..."
                    />
                       {ability.can('read', 'ws') ? (<a href={`/friges/frige0/AddOutputFrige0/1`} color="primary">
                <button className='btn-sm btn btn-primary' style={{marginRight:'830px'}}>إضافة خرج</button>
                </a>) : null}
                </InputGroup>
            ...
            {isLoading ? ( // Show the loading spinner while isLoading is true
                ...
                <div className="react-dataTable">
                    <DataTable
                        noHeader
                        pagination
                        data={searchValue.length ? searchData : store.ZeroFrigeContent}
                        columns={columns}
                        className="react-dataTable"
