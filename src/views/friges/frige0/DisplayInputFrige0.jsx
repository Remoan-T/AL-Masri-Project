...
import { DisplayInputZeroFrigeContent } from "../store";
...
const DataTablesBasic = () => {
    ...
    useEffect(() => {
        dispatch(DisplayInputZeroFrigeContent());
    }, [dispatch, store.InputZeroFrigeContent.length]);
    ...
    const hasData = searchValue.length
        ? searchData.length > 0
        : store.InputZeroFrigeContent.length > 0;
                        ...
                        <h3 className="text-success">
                            ...
                            {store.InputZeroFrigeContent == ""
                                ...
                                : `عدد المدخلات : ${searchValue.length
                                    ? searchData.length
                                    : store.InputZeroFrigeContent.length
                                }`}
                        </h3>
                    </h2>{" "}
                </CardTitle>
                ...
                <div className="d-flex mt-md-0 mt-1">
                    <UncontrolledButtonDropdown>
                        <DropdownToggle
                            ...
                            caret
                            outline
                            disabled={store.InputZeroFrigeContent == ""}
                        >
                            <Share size={15} />
            ...
            {isLoading ? ( // Show the loading spinner while isLoading is true
                ...
                <div className="react-dataTable">
                    <DataTable
                        noHeader
                        pagination
                        data={searchValue.length ? searchData : store.InputZeroFrigeContent}
                        columns={columns}
                        className="react-dataTable"
                        expandableRows={true}
