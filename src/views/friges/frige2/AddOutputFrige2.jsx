...
import { Displayfrige2content, Dropdownfrige2content } from "../store";
...
const DataTablesBasic = () => {
    ...
    useEffect(() => {
        dispatch(Displayfrige2content());
    }, [dispatch, store.frige2content.length]);
    console.log("🚀 ~ file: index.jsx:133 ~ DataTablesBasic ~ store.frige2content:", store.frige2content)
    useEffect(() => {
        dispatch(Dropdownfrige2content());
    }, [dispatch, store.dropdownfrige2content.length]);
    console.log("🚀 ~ file: index.jsx:142 ~ DataTablesBasic ~ store.dropdownfrige2content:", store.dropdownfrige2content)
    ...
    const handleButtonClicked = () => {
        ...
        axios
            .post("http://127.0.0.1:8000/warehouse-supervisor-api/set-from-det-2-to-output", requestBody)
            .then((response) => {
            ...
            <Row className="justify-content-end mx-0">
                <InputGroup className="mb-2">
                    <Select
                        ...
                        // isDisabled={!check}
                        options={store.dropdownfrige2content.map((option) => ({
                            value: option.to,
                            label: option.to,
                        }))}
