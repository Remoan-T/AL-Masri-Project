...
import { Displayfrige2content } from "../store";
        ...
        },
        {
            ...
            cell: row => (
                ...
                <div>
                    ...
                    {ability.can('read', 'ws') ?  (<a href={`/friges/frige2/AddOutputFrige2/${row.id}`}>اضافة خرج </a> ) : null}
            ...
            {isLoading ? ( // Show the loading spinner while isLoading is true
                ...
                <div className="react-dataTable">
                    <DataTable
                        noHeader
                        pagination
                        data={searchValue.length ? searchData : store.frige2content}
                        columns={columns}
                        className="react-dataTable"
