...
import { DisplayInputfrige2content } from "../store";
...
const DataTablesBasic = () => {
    ...
    const ExpandedComponent = ({ data }) => (
        <div>
            <DataTable
                ...
                data={data.detonator_frige2_details}
                columns={columns2}
    ...
    useEffect(() => {
        dispatch(DisplayInputfrige2content());
    }, [dispatch, store.Inputfrige2content.length]);
    ...
    const hasData = searchValue.length
        ? searchData.length > 0
        : store.Inputfrige2content.length > 0;
                        ...
                        <h3 className="text-success">
                            ...
                            {store.Inputfrige2content == ""
                                ...
                                : `عدد المدخلات : ${searchValue.length
                                    ? searchData.length
                                    : store.Inputfrige2content.length
                                }`}
                        </h3>
                    </h2>{" "}
                </CardTitle>
                ...
                {/* <div className="d-flex mt-md-0 mt-1">
                    <UncontrolledButtonDropdown>
                        <DropdownToggle
                            ...
                            caret
                            outline
                            disabled={store.Inputfrige2content == ""}
                        >
                            <Share size={15} />
            ...
            {isLoading ? ( // Show the loading spinner while isLoading is true
                ...
                <div className="react-dataTable">
                    <DataTable
                        noHeader
                        pagination
                        data={searchValue.length ? searchData : store.Inputfrige2content}
                        columns={columns}
                        className="react-dataTable"
                        expandableRows={true}
