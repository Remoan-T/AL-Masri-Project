...
import { DisplayOutputfrige2content } from "../store";
...
const DataTablesBasic = () => {
    const columns = [
        ...
        {
            name: " نوع المادة",
            selector: (row) => row.detonator2.warehouse.out_put__type__production.type,
        },
    ...
    const ExpandedComponent = ({ data }) => (
        <div>
            <DataTable
                ...
                data={store.Outputfrige2content}
                columns={columns2}
    ...
    useEffect(() => {
        dispatch(DisplayOutputfrige2content());
    }, [dispatch, store.Outputfrige2content.length]);
    ...
    const hasData = searchValue.length
        ? searchData.length > 0
        : store.Outputfrige2content.length > 0;
                        ...
                        <h3 className="text-success">
                            ...
                            {store.Outputfrige2content == ""
                                ...
                                : `عدد المخرجات : ${searchValue.length
                                    ? searchData.length
                                    : store.Outputfrige2content.length
                                }`}
                        </h3>
                    </h2>{" "}
                </CardTitle>
                ...
                <div className="d-flex mt-md-0 mt-1">
                    <UncontrolledButtonDropdown>
                        <DropdownToggle
                            ...
                            caret
                            outline
                            disabled={store.Outputfrige2content == ""}
                        >
                            <Share size={15} />
            ...
            {isLoading ? ( // Show the loading spinner while isLoading is true
                ...
                <div className="react-dataTable">
                    <DataTable
                        noHeader
                        pagination
                        data={searchValue.length ? searchData : store.Outputfrige2content}
                        columns={columns}
                        className="react-dataTable"
