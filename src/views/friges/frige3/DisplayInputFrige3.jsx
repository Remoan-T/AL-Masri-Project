...
import { DisplayInputfrige3content } from "../store";
...
const DataTablesBasic = () => {
    ...
    const ExpandedComponent = ({ data }) => (
        <div>
            <DataTable
                ...
                data={data.detonator_frige3_details}
                columns={columns2}
    ...
    useEffect(() => {
        dispatch(DisplayInputfrige3content());
    }, [dispatch, store.Inputfrige3content.length]);
    ...
    const hasData = searchValue.length
        ? searchData.length > 0
        : store.Inputfrige3content.length > 0;
                        ...
                        <h3 className="text-success">
                            ...
                            {store.Inputfrige3content == ""
                                ...
                                : `عدد المدخلات : ${searchValue.length
                                    ? searchData.length
                                    : store.Inputfrige3content.length
                                }`}
                        </h3>
                    </h2>{" "}
                </CardTitle>
                ...
                {/* <div className="d-flex mt-md-0 mt-1">
                    <UncontrolledButtonDropdown>
                        <DropdownToggle
                            ...
                            caret
                            outline
                            disabled={store.Inputfrige3content == ""}
                        >
                            <Share size={15} />
            ...
            {isLoading ? ( // Show the loading spinner while isLoading is true
                ...
                <div className="react-dataTable">
                    <DataTable
                        noHeader
                        pagination
                        data={searchValue.length ? searchData : store.Inputfrige3content}
                        columns={columns}
                        className="react-dataTable"
                        expandableRows={true}
