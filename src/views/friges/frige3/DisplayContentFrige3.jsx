...
import { Displayfrige3content } from "../store";
...
{ability.can('read', 'ws') ?  (<a href={`/friges/frige3/AddOutputFrige3/${row.id}`}>اضافة خرج </a> ) : null}
                </div>
            )
        }
        // {
            ...
            {isLoading ? ( // Show the loading spinner while isLoading is true
                ...
                <div className="react-dataTable">
                    <DataTable
                        noHeader
                        pagination
                        data={searchValue.length ? searchData : store.frige3content}
                        columns={columns}
                        className="react-dataTable"
