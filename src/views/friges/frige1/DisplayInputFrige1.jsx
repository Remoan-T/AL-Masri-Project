...
import { DisplayInputfrige1content } from "../store";
...
const DataTablesBasic = () => {
    ...
    const ExpandedComponent = ({ data }) => (
        <div>
            <DataTable
                ...
                data={data.detonator_frige1_details}
                columns={columns2}
    ...
    useEffect(() => {
        dispatch(DisplayInputfrige1content());
    }, [dispatch, store.Inputfrige1content.length]);
    ...
    const hasData = searchValue.length
        ? searchData.length > 0
        : store.Inputfrige1content.length > 0;
                        ...
                        <h3 className="text-success">
                            ...
                            {store.Inputfrige1content == ""
                                ...
                                : `عدد المخرجات : ${searchValue.length
                                    ? searchData.length
                                    : store.Inputfrige1content.length
                                }`}
                        </h3>
                    </h2>{" "}
                </CardTitle>
                ...
                <div className="d-flex mt-md-0 mt-1">
                    <UncontrolledButtonDropdown>
                        <DropdownToggle
                            ...
                            caret
                            outline
                            disabled={store.Inputfrige1content == ""}
                        >
                            <Share size={15} />
            ...
            {isLoading ? ( // Show the loading spinner while isLoading is true
                ...
                <div className="react-dataTable">
                    <DataTable
                        noHeader
                        pagination
                        data={searchValue.length ? searchData : store.Inputfrige1content}
                        columns={columns}
                        className="react-dataTable"
                        expandableRows={true}
